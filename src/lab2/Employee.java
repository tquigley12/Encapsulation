...
public class Employee {
    ...
    // create class variable for fmtDate
    ...
    // Create a new parent method that calls the other, helper methods
    public void newEmployeeStartup(String cubeID) {
        orientationDate = new Date();
        // Utilize logic in dateUtilities class to execute code that generates
        // fmtDate variable.  This allows us to eliminate duplicate code in 
        // subsequent methods.
        DateUtilities dateUtilities = new DateUtilities();
        fmtDate = dateUtilities.getFormattedDate(orientationDate);
    ...
    // Make this method private because it is called within this class
    private void meetWithHrForBenefitAndSalryInfo() {
        metWithHr = true;
        // the following statements are commented out because they are executed
        // in the common method getFmtDate
